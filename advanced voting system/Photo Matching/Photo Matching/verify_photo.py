...
def detect_face(image):
    modelFile = r"F:\\advanced voting system\\Photo Matching\\Photo Matching\\res10.caffemodel"
    configFile = r"F:\\advanced voting system\\Photo Matching\\Photo Matching\\deploy.prototxt.txt"
